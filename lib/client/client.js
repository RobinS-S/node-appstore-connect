...
class Client {
     ...
     * @param {TestflightAddBuildToExternalGroupOptions?} options
     */
    addBuildToExternalGroupByBuildId(appId, buildId, groupName, options) {
     ...
     */
    createExternalBetaTestersGroup(appId, groupName, options) {
     ...
     * @returns Promise<string> A promise with the group id
     */
    getExternalBetaTestersGroupId(appId, groupName) {
