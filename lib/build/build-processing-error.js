...
exports.BuildProcessingError = void 0;
class BuildProcessingError extends Error {
    constructor(processingState, message) {
        super(message || `Processing failed with state: ${processingState}`);
        this.processingState = processingState;
    }
}
exports.BuildProcessingError = BuildProcessingError;
//# sourceMappingURL=build-processing-error.js.map